...
#14 naming to docker.io/config-template/nautobot:latest-py3.7 done
```
...
Creating network "config_template_default" with the default driver
Creating volume "config_template_postgres_data" with default driver
Creating config_template_redis_1 ... 
Creating config_template_docs_1  ... 
Creating config_template_postgres_1 ... 
Creating config_template_postgres_1 ... done
Creating config_template_redis_1    ... done
Creating config_template_nautobot_1 ... 
Creating config_template_docs_1     ... done
Creating config_template_nautobot_1 ... done
Creating config_template_worker_1   ... 
Creating config_template_worker_1   ... done
...
ee90fbfabd77   config-template/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               config_template_worker_1
b8adb781d013   config-template/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   config_template_nautobot_1
d64ebd60675d   config-template/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   config_template_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   config_template_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   config_template_redis_1
```
...
Stopping config_template_worker_1   ... 
Stopping config_template_nautobot_1 ... 
Stopping config_template_docs_1     ... 
Stopping config_template_redis_1    ... 
Stopping config_template_postgres_1 ... 
Stopping config_template_worker_1   ... done
Stopping config_template_nautobot_1 ... done
Stopping config_template_postgres_1 ... done
Stopping config_template_redis_1    ... done
Stopping config_template_docs_1     ... done
Removing config_template_worker_1   ... 
Removing config_template_nautobot_1 ... 
Removing config_template_docs_1     ... 
Removing config_template_redis_1    ... 
Removing config_template_postgres_1 ... 
Removing config_template_postgres_1 ... done
Removing config_template_docs_1     ... done
Removing config_template_worker_1   ... done
Removing config_template_redis_1    ... done
Removing config_template_nautobot_1 ... done
Removing network config_template_default
```
...
So for example, our plugin is named `config-template`, the command would most likely be `docker logs config_template_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("config_template")
namespace.configure(
    {
        "config_template": {
            ...
...
Or set the `INVOKE_CONFIG_TEMPLATE_PYTHON_VER` variable
...
Or set the `INVOKE_CONFIG_TEMPLATE_NAUTOBOT_VER` variable
